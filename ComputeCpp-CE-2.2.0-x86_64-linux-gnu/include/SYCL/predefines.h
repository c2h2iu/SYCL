...
/** Set the the default value of SYCL_LANGUAGE_VERSION to 2017 if it has
 * not been specified.
 */
#ifndef SYCL_LANGUAGE_VERSION
#define SYCL_LANGUAGE_VERSION 2017
#endif  // SYCL_LANGUAGE_VERSION

/** Set the value of CL_SYCL_LANGUAGE_VERSION or based on the value of
 * SYCL_LANGUAGE_VERSION.
 */
#if (SYCL_LANGUAGE_VERSION == 2017)
#define CL_SYCL_LANGUAGE_VERSION 121
#elif SYCL_LANGUAGE_VERSION == 2020
...
#endif  // (defined ANDROID || defined ARM)
...
/** COMPUTECPP_DEPRECATED_BY_SYCL_2020(message)
 ...
 */
#define COMPUTECPP_DEPRECATED_BY_SYCL_2020(message) \
  COMPUTECPP_DEPRECATED_API("Deprecated or removed in SYCL 2020. " message)
#else
#define COMPUTECPP_DEPRECATED_BY_SYCL_2020(message)
 ...
 * COMPUTECPP_DEPRECATED_API if the chosen version specified by
 * SYCL_LANGUAGE_VERSION is greater than or equal to 2017.
 */
#define COMPUTECPP_DEPRECATED_BY_SYCL_2017(message) \
