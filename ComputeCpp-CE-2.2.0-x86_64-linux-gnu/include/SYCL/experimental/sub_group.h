 ...
 */
template <class T>
struct identity<T, experimental::plus<T>> {
 ...
 */
template <class T>
struct identity<T, experimental::multiplies<T>> {
 ...
 */
template <class T>
struct identity<T, experimental::bit_and<T>> {
 ...
 */
template <class T>
struct identity<T, experimental::bit_or<T>> {
  static constexpr T value = 0;
};
 ...
 */
template <class T>
struct identity<T, experimental::bit_xor<T>> {
  static constexpr T value = 0;
};
 ...
 */
template <class T>
struct identity<T, experimental::logical_and<T>> {
 ...
 */
template <class T>
struct identity<T, experimental::logical_or<T>> {
 ...
 */
template <class T>
struct identity<T, experimental::minimum<T>> {
 ...
 */
template <class T>
struct identity<T, experimental::maximum<T>> {
...
struct sub_group {
 public:
   ...
   */
  COMPUTECPP_DEPRECATED_BY_SYCL_VER(2020,
  ...
  inline T exclusive_scan(T x, BinaryOp binaryOp) const {
    return detail::identity<T, BinaryOp>::value;
  }
