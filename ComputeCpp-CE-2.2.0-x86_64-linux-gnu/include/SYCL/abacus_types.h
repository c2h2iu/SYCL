...
struct convert_abacus_sycl<cl::sycl::vec<char, dims>> {
  using abacus_type = abacus_vector<char, dims>;
  using abacus_utype = abacus_vector<unsigned char, dims>;
  using sycl_utype = cl::sycl::vec<cl::sycl::cl_uchar, dims>;
};
...
struct convert_abacus_sycl<cl::sycl::vec<cl::sycl::cl_char, dims>> {
  using abacus_type = abacus_vector<signed char, dims>;
  using abacus_utype = abacus_vector<unsigned char, dims>;
  using sycl_utype = cl::sycl::vec<cl::sycl::cl_uchar, dims>;
};
...
struct convert_abacus_sycl<cl::sycl::vec<cl::sycl::cl_uchar, dims>> {
  using abacus_type = abacus_vector<abacus_uchar, dims>;
  using abacus_utype = abacus_vector<abacus_uchar, dims>;
  using sycl_utype = cl::sycl::vec<cl::sycl::cl_uchar, dims>;
};
...
struct convert_abacus_sycl<cl::sycl::vec<cl::sycl::cl_short, dims>> {
  using abacus_type = abacus_vector<int16_t, dims>;
  using abacus_utype = abacus_vector<uint16_t, dims>;
  using sycl_utype = cl::sycl::vec<cl::sycl::cl_ushort, dims>;
};
...
struct convert_abacus_sycl<cl::sycl::vec<cl::sycl::cl_ushort, dims>> {
  using abacus_type = abacus_vector<abacus_ushort, dims>;
  using abacus_utype = abacus_vector<abacus_ushort, dims>;
  using sycl_utype = cl::sycl::vec<cl::sycl::cl_ushort, dims>;
};
...
struct convert_abacus_sycl<cl::sycl::vec<cl::sycl::cl_uint, dims>> {
  using abacus_type = abacus_vector<abacus_uint, dims>;
  using abacus_utype = abacus_vector<abacus_uint, dims>;
  using sycl_utype = cl::sycl::vec<cl::sycl::cl_uint, dims>;
};
...
struct convert_abacus_sycl<cl::sycl::vec<cl::sycl::cl_int, dims>> {
  using abacus_type = abacus_vector<int, dims>;
  using abacus_utype = abacus_vector<unsigned int, dims>;
  using sycl_utype = cl::sycl::vec<cl::sycl::cl_uint, dims>;
};
...
struct convert_abacus_sycl<cl::sycl::vec<long, dims>> {
  using abacus_type = abacus_vector<abacus_long, dims>;
  using abacus_utype = abacus_vector<abacus_ulong, dims>;
  using sycl_utype = cl::sycl::vec<cl::sycl::cl_ulong, dims>;
};
...
struct convert_abacus_sycl<cl::sycl::vec<unsigned long, dims>> {
  using abacus_type = abacus_vector<abacus_ulong, dims>;
  using abacus_utype = abacus_vector<abacus_ulong, dims>;
  using sycl_utype = cl::sycl::vec<cl::sycl::cl_ulong, dims>;
};
...
struct convert_abacus_sycl<cl::sycl::vec<cl::sycl::cl_float, dims>> {
  using abacus_type = abacus_vector<abacus_float, dims>;
  using abacus_utype = abacus_vector<abacus_float, dims>;
  using sycl_utype = cl::sycl::vec<cl::sycl::cl_float, dims>;
};
...
struct convert_abacus_sycl<cl::sycl::vec<cl::sycl::cl_double, dims>> {
  using abacus_type = abacus_vector<abacus_double, dims>;
  using abacus_utype = abacus_vector<abacus_double, dims>;
  using sycl_utype = cl::sycl::vec<cl::sycl::cl_double, dims>;
};
...
struct convert_abacus_sycl<cl::sycl::vec<cl::sycl::half, dims>> {
  using abacus_type = abacus_vector<cl::sycl::cl_float, dims>;
  using abacus_utype = abacus_vector<cl::sycl::cl_float, dims>;
  using sycl_utype = cl::sycl::vec<cl::sycl::cl_float, dims>;
};
