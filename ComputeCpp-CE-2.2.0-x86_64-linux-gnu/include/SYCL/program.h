...
class COMPUTECPP_EXPORT program {
  ...
  */
  ...
  void compile_with_kernel_type(string_class compileOptions = "") {
    ...
    this->compile_with_kernel_type_impl(binaryData, binarySize,
                                        requiredExtensions,
  ...
  */
  ...
  void build_with_kernel_type(string_class buildOptions = "") {
    ...
    this->build_with_kernel_type_impl(binaryData, binarySize,
                                      requiredExtensions, buildOptions.c_str(),
                                      binInfo.target);
  }
  ...
  */
  ...
  static program create_program_for_kernel(cl::sycl::context c) {
    ...
    return program(create_program_for_kernel_impl(
        kernelName.c_str(), data, dataSize, requiredExtensions, c.get_impl(),
        binInfo.target));
  }
  /// COMPUTECPP_DEV @endcond
